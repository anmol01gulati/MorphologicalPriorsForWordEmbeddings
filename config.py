config = {}
config['batch_size'] = 30  # number of samples taken per each update
config['hidden_size'] = 128  # number of hidden units per layer
config['max_morphemes_per_word'] = 6 # NOTE: This needs to be set depending on the dataset.
config['num_layers'] = 2
...
config['nepochs'] = 15  # number of full passes through the training data
